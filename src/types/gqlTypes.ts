...
/** Autogenerated input type of CreateOrUpdateHousehold */
export type CreateOrUpdateHouseholdInput = {
  clientId: Scalars['ID'];
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  confirmed?: InputMaybe<Scalars['Boolean']>;
...
/** Autogenerated return type of CreateOrUpdateHousehold. */
export type CreateOrUpdateHouseholdPayload = {
  __typename?: 'CreateOrUpdateHouseholdPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  errors: Array<ValidationError>;
...
export type Mutation = {
  ...
  createOrUpdateHousehold?: Maybe<CreateOrUpdateHouseholdPayload>;
...
export type MutationCreateOrUpdateHouseholdArgs = {
  input: CreateOrUpdateHouseholdInput;
};
...
export type CreateOrUpdateHouseholdMutationVariables = Exact<{
  input: CreateOrUpdateHouseholdInput;
}>;

export type CreateOrUpdateHouseholdMutation = {
  __typename?: 'Mutation';
...
export type UpdateRelationshipToHoHMutationOptions = Apollo.BaseMutationOptions<
  ...
  UpdateRelationshipToHoHMutationVariables
>;
export const CreateOrUpdateHouseholdDocument = gql`
  ...
  ${ValidationErrorFieldsFragmentDoc}
`;
export type CreateOrUpdateHouseholdMutationFn = Apollo.MutationFunction<
  CreateOrUpdateHouseholdMutation,
  CreateOrUpdateHouseholdMutationVariables
>;

/**
 * __useCreateOrUpdateHouseholdMutation__
 *
 * To run a mutation, you first call `useCreateOrUpdateHouseholdMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateOrUpdateHouseholdMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createOrUpdateHouseholdMutation, { data, loading, error }] = useCreateOrUpdateHouseholdMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateOrUpdateHouseholdMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CreateOrUpdateHouseholdMutation,
    CreateOrUpdateHouseholdMutationVariables
  >
  ...
  return Apollo.useMutation<
    CreateOrUpdateHouseholdMutation,
    CreateOrUpdateHouseholdMutationVariables
  >(CreateOrUpdateHouseholdDocument, options);
}
export type CreateOrUpdateHouseholdMutationHookResult = ReturnType<
  typeof useCreateOrUpdateHouseholdMutation
>;
export type CreateOrUpdateHouseholdMutationResult =
  Apollo.MutationResult<CreateOrUpdateHouseholdMutation>;
export type CreateOrUpdateHouseholdMutationOptions = Apollo.BaseMutationOptions<
  CreateOrUpdateHouseholdMutation,
  CreateOrUpdateHouseholdMutationVariables
>;
