...
export type ClearMciPayload = {
  ...
  clientMutationId?: Maybe<Scalars['String']>;
  errors: Array<ValidationError>;
  matches?: Maybe<Array<MciClearanceResult>>;
};
...
export type MciClearanceResult = {
  __typename?: 'MciClearanceResult';
  client: MciClient;
...
export type MciClient = {
  __typename?: 'MciClient';
  age: Scalars['Int'];
  dob: Scalars['ISO8601Date'];
  firstName: Scalars['String'];
  gender: Array<Gender>;
...
export type MciClientFragmentFragment = {
  __typename?: 'MciClient';
  id: string;
  age: number;
  dob: string;
...
export type MciClearanceResultFragmentFragment = {
  __typename?: 'MciClearanceResult';
  id: string;
  score: number;
...
`;
export const MciClientFragmentFragmentDoc = gql`
  fragment MciClientFragment on MciClient {
    id
    age
    dob
    firstName
...
`;
export const MciClearanceResultFragmentFragmentDoc = gql`
  fragment MciClearanceResultFragment on MciClearanceResult {
    id
    score
    existingClientId
    client {
...
export const ClearMciDocument = gql`
  ...
  ${MciClearanceResultFragmentFragmentDoc}
  ${ValidationErrorFieldsFragmentDoc}
`;
