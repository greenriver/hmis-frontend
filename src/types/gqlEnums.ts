...
export const HmisEnums = {
  ...
  ReferralPostingStatus: {
    accepted_by_other_program_status: 'accepted_by_other_program_status',
    accepted_pending_status: 'accepted_pending_status',
    accepted_status: 'accepted_status',
    assigned_status: 'assigned_status',
    assigned_to_other_program_status: 'assigned_to_other_program_status',
    closed_status: 'closed_status',
    denied_pending_status: 'denied_pending_status',
    denied_status: 'denied_status',
    new_status: 'new_status',
    not_selected_status: 'not_selected_status',
