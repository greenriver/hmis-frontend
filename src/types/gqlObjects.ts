...
export const HmisObjectSchemas: GqlSchema[] = [
  ...
  {
    name: 'CeReferralSourceEnrollment',
    fields: [
      {
        name: 'autoExited',
        type: {
      ...
      {
        name: 'sourceClientMeetsEligibility',
        type: {
          kind: 'NON_NULL',
          name: null,
          ofType: { kind: 'SCALAR', name: 'Boolean', ofType: null },
  ...
  {
    name: 'CeReferralSourceEnrollmentAccess',
    fields: [
      {
  ...
  {
    name: 'CeReferralSourceHouseholdMember',
    fields: [
      {
        name: 'clientId',
        type: {
  ...
  {
    name: 'CeReferralSourceHouseholdMemberAccess',
    fields: [
      {
        name: 'canViewClients',
        type: {
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: 'autoExitDaysThreshold',
        type: { kind: 'SCALAR', name: 'Int', ofType: null },
      },
      {
        name: 'autoExitEnabled',
        type: {
          kind: 'NON_NULL',
          name: null,
          ofType: { kind: 'SCALAR', name: 'Boolean', ofType: null },
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: 'canManageCeDefaultContacts',
        type: {
          kind: 'NON_NULL',
          name: null,
          ofType: { kind: 'SCALAR', name: 'Boolean', ofType: null },
...
export const HmisInputObjectSchemas: GqlInputObjectSchema[] = [
  ...
  {
    name: 'ProjectConfigFilterOptions',
    args: [
      {
        name: 'configType',
        type: {
