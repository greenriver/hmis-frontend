import { formValueToGqlValue, itemDefaults } from './formUtil';

import { ItemType } from '@/types/gqlTypes';

describe('formValueToGqlValue', () => {
  it('transform value into string', () => {
    const item = { ...itemDefaults, linkId: 'abc', type: ItemType.String };
  ...
  it('transforms value into date string', () => {
    const item = { ...itemDefaults, linkId: 'abc', type: ItemType.Date };
  ...
  it('transforms value into integer', () => {
    const item = { ...itemDefaults, linkId: 'abc', type: ItemType.Integer };
  ...
  it('transforms single-select choice', () => {
    const item = { ...itemDefaults, linkId: 'abc', type: ItemType.Choice };
